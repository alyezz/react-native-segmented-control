...
import { PolyText } from '@/Components';
...
const SegmentedControl = ({
  ...
  useEffect(() => {
    ...
    tabTranslateValue.value = withSpring(currentIndex * (translateValue * transitionMultiplier), DEFAULT_SPRING_CONFIG);
      ...
      <Animated.View
        style={[
          ...
          StyleSheet.absoluteFill,
          {
            ...
            backgroundColor: movingSegmentColor,
          },
              ...
              {badgeValues[index] && (
                <View
                  ...
                  style={[
                    ...
                    currentIndex === index ? finalisedActiveBadgeStyle : finalisedInActiveBadgeStyle,
                  ]}
                >
                  <PolyText style={finalisedBadgeTextStyle}>{badgeValues[index]}</PolyText>
                </View>
              )}
            </View>
          </Pressable>
